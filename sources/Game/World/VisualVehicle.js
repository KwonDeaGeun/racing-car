...
export class VisualVehicle
{
    ...
    setParts()
    {
        ...
        // Navigation-only antenna meshes are not part of the race vehicle.
        for(const name of [ 'antenna', 'antennaHead' ])
            this.model.getObjectByName(name)?.removeFromParent()
    ...
    setPaints()
    {
        ...
        // The race launcher owns paint selection; every paint is available.
        this.paints.changeTo('red')
    }
