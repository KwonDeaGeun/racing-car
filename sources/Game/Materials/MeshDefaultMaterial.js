...
export class MeshDefaultMaterial extends THREE.MeshLambertNodeMaterial
{
    ...
    constructor(parameters = {})
    {
        ...
        // Terrain is not part of the race-only build, so terrain-sampled bounce
        // lighting must be explicitly opted into instead of enabled by default.
        this.hasLightBounce = parameters.hasLightBounce ?? false
        this.hasFog = parameters.hasFog ?? true
        this.hasWater = parameters.hasWater ?? true
        this.hasReveal = parameters.hasReveal ?? false
